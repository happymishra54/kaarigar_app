...
Future<void> loadDashboard() async {
    ...
    if (token != null) {
      ...
      // Load dashboard stats and worker info
      await provider.loadDashboard(token);
      // Also load full bookings list for recent bookings display
            ...
            Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: statusBg.withValues(alpha: .15),
  ...
  Widget _buildRecentBookingsSection(dynamic dashboard, WorkerDashboardProvider provider) {
    if (provider.loading) {
    ...
    // Check for bookings in dashboard response, or fall back to provider.bookings loaded separately
    final List recentBookings = (dashboard?['recent_bookings'] ?? dashboard?['bookings'] ?? provider.bookings ?? []) as List;
    ...
    return Column(
      children: recentBookings.map<Widget>((booking) => _buildBookingCard(booking)).toList(),
    );
  }
...
// Profile Header Card
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(city.isEmpty ? "Not Added" : city),
                  ),
                  const Divider(),
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                    ...
                    subtitle: Text(state.isEmpty ? "Not Added" : state),
                  ),
                  const Divider(),
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                    ...
                    subtitle: Text(address.isEmpty ? "Not Added" : address),
                  ),
                  const Divider(),
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                    ...
                    subtitle: Text(mobile.isEmpty ? "Not Added" : mobile),
                  ),
                  const Divider(),
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                    ...
                    subtitle: Text(email.isEmpty ? "Not Added" : email),
                  ),
                  const Divider(),
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                  ...
                  ListTile(
                    ...
                    subtitle: Text(bio.isEmpty ? "Not Added" : bio),
                  ),
                  const Divider(),
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                    ...
                    subtitle: Text(
                      experience.isEmpty ? "Not Added" : "$experience Years",
                    ),
                  ),
                  const Divider(),
                  ListTile(
                    ...
                    subtitle: Text(
                      dailyWage.isEmpty ? "Not Added" : "\u20B9 $dailyWage / Day",
                    ),
                  ),
                  const Divider(),
                  ListTile(
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                      isVerified ? "Verified Worker" : "Verification Pending",
                      style: TextStyle(
                        color: isVerified ? Colors.green : Colors.orange,
                        fontWeight: FontWeight.w600,
                      ),
            ...
            _buildRecentBookingsSection(dashboard, provider),
